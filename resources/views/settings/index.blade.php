      ...
      <form method="post" action="{{ route('settings.update') }}" class="settings-account-form">
        ...
        <div class="settings-account-grid">
          ...
          <label class="settings-account-field-card is-confirm">
            ...
            <input type="password" name="new_password_confirm" autocomplete="new-password" required minlength="6">
          </label>
        </div>

        <div class="settings-account-actions">
          <button class="btn" type="submit" @if ($centralReadOnly) disabled aria-disabled="true" @endif>Ubah Password</button>
        </div>
      </form>
    </section>
@endsection
