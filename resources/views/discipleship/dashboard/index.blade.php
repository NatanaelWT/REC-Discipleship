...
if ($showDashboardStats) {
    ...
    if (isset($_GET['converted'])) {
        echo "<div class=\"alert success\">Peserta luar yang menyelesaikan 12 sesi otomatis ditambahkan ke data pemuridan.</div>\n";
    }
...
if ($showDashboardStats) {
    ...
    if (is_effective_central_discipleship_readonly()) {
        ...
        if ($targetSelectedBranch === 'all') {
            ...
            foreach (public_dg_branch_options() as $branchOption) {
                ...
                $branchTargets = $discipleshipTargetsByBranch[$branchCode] ?? [];
            ...
            $selectedBranchTargets = $discipleshipTargetsByBranch[$targetSelectedBranch] ?? [];
    ...
    echo "      <p class=\"discipleship-dashboard-hero-actions\"><a class=\"btn\" href=\"/\">Buka Halaman Public Link</a></p>\n";
    echo "    </div>\n";
