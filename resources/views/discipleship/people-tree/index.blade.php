...
if ($page === 'people_tree') {
    ...
    echo ".tree-group-journal-table{min-width:1180px;}\n";
    ...
    echo ".tree-group-journal-table th:nth-child(5),.tree-group-journal-table td:nth-child(5){width:7%;}\n";
    echo ".tree-group-journal-table th:nth-child(6),.tree-group-journal-table td:nth-child(6){width:14%;}\n";
    echo ".tree-group-journal-table th:nth-child(7),.tree-group-journal-table td:nth-child(7){width:11%;}\n";
    echo ".tree-group-journal-table th:nth-child(8),.tree-group-journal-table td:nth-child(8){width:7%;}\n";
    echo ".tree-group-journal-table th:nth-child(9),.tree-group-journal-table td:nth-child(9){width:5%;}\n";
    ...
    echo ".tree-group-journal-photo-links{margin-top:4px;}\n";
    echo ".tree-group-journal-photo-links .note-link{font-size:10px;}\n";
