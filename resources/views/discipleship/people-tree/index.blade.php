...
if ($page === 'people_tree') {
    ...
    echo ".tree-group-history-roster{display:grid;gap:8px;padding:9px 10px;border:1px solid rgba(226,232,240,.95);border-radius:14px;background:rgba(248,250,252,.78);}\n";
    echo ".tree-group-history-roster-head{display:flex;align-items:center;justify-content:space-between;gap:8px;}\n";
    echo ".tree-group-history-roster-head .journey-history-section-title{margin-top:0;}\n";
    echo ".tree-group-history-roster-head span{font-size:10px;color:#64748b;font-weight:800;white-space:nowrap;}\n";
    echo ".tree-group-history-roster-list{display:grid;grid-template-columns:repeat(auto-fit,minmax(210px,1fr));gap:6px;align-items:stretch;}\n";
    echo ".tree-group-history-roster-pill{display:grid;grid-template-columns:auto minmax(0,1fr);gap:2px 8px;align-items:center;min-width:0;padding:7px 9px;border-radius:11px;background:#fff;border:1px solid rgba(226,232,240,.92);}\n";
    echo ".tree-group-history-roster-kind{display:inline-flex;align-items:center;justify-content:center;min-height:22px;padding:3px 8px;border-radius:999px;background:rgba(148,163,184,.12);color:#475569;font-size:9px;font-weight:900;text-transform:uppercase;letter-spacing:.03em;}\n";
    echo ".tree-group-history-roster-pill.is-leader .tree-group-history-roster-kind{background:rgba(15,118,110,.1);color:#0f766e;}\n";
    echo ".tree-group-history-roster-pill strong{font-size:11px;line-height:1.25;color:#0f172a;overflow-wrap:anywhere;min-width:0;}\n";
    echo ".tree-group-history-roster-meta{grid-column:2;font-size:9px;line-height:1.3;color:#64748b;font-weight:700;overflow-wrap:anywhere;}\n";
    echo ".tree-group-history-roster-note{grid-column:1/-1;font-size:9px;line-height:1.3;color:#64748b;}\n";
    echo ".tree-group-journal-table-wrap{border-radius:14px;max-height:none;}\n";
    echo ".tree-group-journal-table{min-width:1080px;}\n";
    echo ".tree-group-journal-table th{font-size:10px;line-height:1.25;}\n";
    echo ".tree-group-journal-table th,.tree-group-journal-table td{padding:9px 10px;}\n";
    echo ".tree-group-journal-table th:nth-child(1),.tree-group-journal-table td:nth-child(1){width:13%;}\n";
    echo ".tree-group-journal-table th:nth-child(2),.tree-group-journal-table td:nth-child(2){width:13%;}\n";
    echo ".tree-group-journal-table th:nth-child(3),.tree-group-journal-table td:nth-child(3){width:15%;}\n";
    echo ".tree-group-journal-table th:nth-child(4),.tree-group-journal-table td:nth-child(4){width:15%;}\n";
    echo ".tree-group-journal-table th:nth-child(5),.tree-group-journal-table td:nth-child(5){width:8%;}\n";
    echo ".tree-group-journal-table th:nth-child(6),.tree-group-journal-table td:nth-child(6){width:14%;}\n";
    echo ".tree-group-journal-table th:nth-child(7),.tree-group-journal-table td:nth-child(7){width:12%;}\n";
    echo ".tree-group-journal-table th:nth-child(8),.tree-group-journal-table td:nth-child(8){width:10%;overflow-wrap:anywhere;}\n";
    echo ".tree-group-journal-table .dg-recap-text{min-width:0;font-size:11px;line-height:1.4;}\n";
    echo ".tree-group-journal-table .dg-recap-main-cell{gap:5px;}\n";
    echo ".tree-group-journal-table .dg-recap-main-title{font-size:12px;line-height:1.35;}\n";
    echo ".tree-group-journal-table .dg-recap-subtext{font-size:10px;line-height:1.35;}\n";
    echo ".tree-group-journal-table .dg-recap-stage-pill{min-height:24px;padding:4px 8px;font-size:10px;}\n";
    echo ".tree-group-journal-table .dg-recap-number-chip{min-width:58px;min-height:30px;padding:5px 9px;font-size:11px;}\n";
    echo ".tree-group-journal-table .chip{font-size:10px;padding:3px 7px;}\n";
    echo ".tree-group-journal-photo-links{display:grid;gap:3px;margin-top:4px;}\n";
    echo ".tree-group-journal-photo-links .note-link{display:inline-block;max-width:100%;font-size:10px;line-height:1.3;white-space:normal;overflow-wrap:anywhere;}\n";
