...
if ($page === 'people_tree') {
    ...
    echo ".tree-group-journal-table th:nth-child(1),.tree-group-journal-table td:nth-child(1){width:14%;}\n";
    echo ".tree-group-journal-table th:nth-child(2),.tree-group-journal-table td:nth-child(2){width:14%;}\n";
    echo ".tree-group-journal-table th:nth-child(3),.tree-group-journal-table td:nth-child(3){width:16%;}\n";
    echo ".tree-group-journal-table th:nth-child(4),.tree-group-journal-table td:nth-child(4){width:16%;}\n";
    echo ".tree-group-journal-table th:nth-child(5),.tree-group-journal-table td:nth-child(5){width:8%;}\n";
    echo ".tree-group-journal-table th:nth-child(6),.tree-group-journal-table td:nth-child(6){width:15%;}\n";
    echo ".tree-group-journal-table th:nth-child(7),.tree-group-journal-table td:nth-child(7){width:11%;}\n";
    echo ".tree-group-journal-table th:nth-child(8),.tree-group-journal-table td:nth-child(8){width:6%;}\n";
