...
if ($page === 'public_dg_branch') {
    page_header_plain('Pilih Cabang Jurnal Temu DG', $settings, 'page-dg-public page-public-dg-branch');
    ...
    echo "        <h2>Pilih Cabang Jurnal Temu DG</h2>\n";
    echo "        <p class=\"public-branch-subtitle\">Pilih cabang terlebih dahulu untuk membuka Jurnal Temu DG.</p>\n";
    echo "      </div>\n";
