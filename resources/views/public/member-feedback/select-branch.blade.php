@extends('layouts.rec_plain', [
    'title' => 'Pilih Cabang Jurnal Umpan Balik Anggota',
    'settings' => $settings,
    'bodyClass' => 'page-dg-public page-public-dg-branch page-public-member-feedback-branch',
])
      ...
      <div class="public-branch-head">
        <div class="card-row public-branch-title-row">
          <div class="public-branch-title-wrap">
            <h2>Pilih Cabang Jurnal Umpan Balik Anggota</h2>
            <p class="public-branch-subtitle">Pilih cabang terlebih dahulu untuk membuka jurnal umpan balik anggota DG.</p>
          </div>
        ...
        <div class="public-branch-grid">
          @foreach ($branchOptions as $branchOption)
            ...
            <a class="public-branch-link-card" href="{{ route('public.member-feedback.form', $hrefParams) }}" aria-label="Isi jurnal umpan balik cabang {{ $branchLabel }}">
              ...
              <span class="public-branch-card-cta">Isi Jurnal <svg viewBox="0 0 20 20" focusable="false" aria-hidden="true"><path d="M7 4l6 6-6 6"/></svg></span>
            </a>
          @endforeach
        </div>
      </div>
