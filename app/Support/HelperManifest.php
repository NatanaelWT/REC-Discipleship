...
class HelperManifest
{
    ...
    private const DISCIPLESHIP = [
        ...
        'filter_active_members', 'format_member_birth_day_month', 'format_parent_names', 'get_parent_ids',
        ...
        'normalize_journey_bridge_status', 'normalize_member_birth_day_month_value', 'normalize_member_gender_value',
