...
class HelperManifest
{
    private const CORE = [
        ...
        'h', 'is_central_discipleship_readonly_session', 'is_developer_access_mode', 'is_developer_session', 'is_developer_testing_branch', 'is_discipleship_action',
    ...
    private const DISCIPLESHIP = [
        ...
        'dgv2_canonical_identity_source_id', 'dgv2_complete_group',
        ...
        'dgv2_payload_member_ids', 'dgv2_people_projection', 'dgv2_person_active_group_ids',
