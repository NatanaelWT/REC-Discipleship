...
return [
    ...
    */
    'tables' => [
        ...
        'request_activities' => ['id', 'method', 'route_name', 'started_at', 'completed_at'],
        'audit_events' => ['id', 'request_id', 'category', 'action', 'occurred_at'],
        'website_daily_rollups' => ['id', 'activity_date', 'dimension_hash', 'page_views'],
        'maintenance_runs' => ['id', 'status', 'cursor', 'heartbeat_at'],
