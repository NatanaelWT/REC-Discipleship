...
use App\Http\Controllers\Developer\DeveloperDatabaseController;
...
Route::middleware('rec.maintenance')->group(function (): void {
    ...
    Route::prefix('developer')->name('developer.')->middleware('rec.page:developer_dashboard')->group(function (): void {
        ...
        Route::get('/database', [DeveloperDatabaseController::class, 'index'])->name('database');
        Route::post('/database/query', [DeveloperDatabaseController::class, 'query'])->name('database.query');
        Route::get('/database/export', [DeveloperDatabaseController::class, 'export'])->name('database.export');
        Route::post('/database/import', [DeveloperDatabaseController::class, 'import'])->name('database.import');
        Route::get('/database/{table}', [DeveloperDatabaseController::class, 'table'])->name('database.table');
        Route::post('/database/{table}/rows', [DeveloperDatabaseController::class, 'storeRow'])->name('database.rows.store');
        Route::post('/database/{table}/rows/{key}', [DeveloperDatabaseController::class, 'updateRow'])->name('database.rows.update');
        Route::post('/database/{table}/rows/{key}/delete', [DeveloperDatabaseController::class, 'deleteRow'])->name('database.rows.delete');
