...
Route::group([], function (): void {
    ...
    Route::prefix('pemuridan')->name('discipleship.')->middleware('rec.auth')->group(function (): void {
        ...
        Route::post('/spiritual-journey/{participant:public_id}/bridge-status', [DiscipleshipSpiritualJourneyController::class, 'updateBridgeStatus'])->middleware('rec.page:spiritual_journey')->name('spiritual-journey.bridge-status');
        ...
        Route::post('/msk/{participant:public_id}/sesi', [DiscipleshipMskParticipantController::class, 'updateSessions'])->middleware('rec.page:msk_classes')->name('msk-classes.sessions');
        Route::post('/msk/{participant:public_id}/nonaktif', [DiscipleshipMskParticipantController::class, 'deactivate'])->middleware('rec.page:msk_classes')->name('msk-classes.deactivate');
        Route::post('/msk/{participant:public_id}/aktif', [DiscipleshipMskParticipantController::class, 'reactivate'])->middleware('rec.page:msk_classes')->name('msk-classes.reactivate');
