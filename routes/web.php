...
Route::middleware('rec.maintenance')->group(function (): void {
    ...
    Route::prefix('pemuridan')->name('discipleship.')->middleware('rec.auth')->group(function (): void {
        ...
        Route::get('/anggota/{person}/detail', [DiscipleshipPeopleListController::class, 'detail'])->whereNumber('person')->middleware('rec.page:people_list')->name('people-list.detail');
        ...
        Route::post('/pohon/kelompok/pindah', [DiscipleshipPeopleTreeController::class, 'movePersonGroup'])->middleware('rec.page:people_tree')->name('tree.groups.move');
